...
export const FAQS: FAQItem[] = [
  {
    ...
    answer: "Це «контрольований злам». Ми намагаємось зламати ваш сайт чи додаток так, як це зробили б справжні хакери. Тільки замість того, щоб вкрасти гроші, ми пишемо звіт про те, де у вас «відкриті двері», і допомагаємо їх закрити."
  },
  {
    question: "Хто такі IT Specialist?",
    answer: "Ми — Українська компанія, що надає професійні послуги у сфері ІТ та кібербезпеки на українському та закордонному ринку.\n\nНаш успіх - це успіх наших клієнтів. Тому ми піклуємося про безпеку та безперервну роботу їхнього бізнесу. Нас цінують за індивідуальний підхід до кожного проєкту та уважність до найбільш непомітних деталей."
  },
  {
